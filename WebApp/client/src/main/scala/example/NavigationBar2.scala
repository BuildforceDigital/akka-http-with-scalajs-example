...
case class NavigationBarBuilder2(tabs: Seq[NavigationTab],
                                 ...
                                 styles: Seq[NavigationBarStyle],
                                 container: Modifier ⇒ Modifier,
                                 contentContainer: Modifier ⇒ Modifier, elemLeft: Seq[Modifier],
...
object NavigationBar2 {
  def apply(tabs: Seq[NavigationTab] = Nil,
           ...
           (implicit ctx: Ctx.Owner) = NavigationBarBuilder2(tabs, barId, brand, styles,  container, contentContainer, elemLeft, elemRight)
}
