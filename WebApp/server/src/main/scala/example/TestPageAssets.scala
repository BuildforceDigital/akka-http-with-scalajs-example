...
object TestPageAssets {
  def index: String = {
    val bootstrapCDN = "https://maxcdn.bootstrapcdn.com/"
    ...
    "<!DOCTYPE html>" + html(cls:="no-js", lang := "" )(
      head(
        meta(charset := "UTF-8"),
    ...
    link(
          ...
          href := bootstrapCDN + "bootstrap/3.3.7/css/bootstrap.min.css",
          media := "screen", rel := "stylesheet"),

        link(attr("crossOrigin") := "anonymous",
          href := bootstrapCDN + "font-awesome/4.7.0/css/font-awesome.min.css",
          media := "screen", rel := "stylesheet"),
